...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      local parsers = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'vue', 'css', 'scss' }
...
-- FIXME: This needs to be re-done with the new nvim-treesitter API
